...
public class DBConstants {
	...
	public static final String IS_RECURRENT = "select RECURRENT_USER from reduction where VEHICLE_REG_NUMBER=?";
	public static final String ADD_RECURRENT = "insert into reduction(VEHICLE_REG_NUMBER,RECURRENT_USER) values(?,?)";
}
